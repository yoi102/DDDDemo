...
namespace GameManagement.Api.Filters
{
    public class JWTValidationFilter : IAsyncActionFilter
    {
        ...
        public JWTValidationFilter(IMemoryCache memoryCache, UserManager<ApiIdentityUser> userManager)
        {
        ...
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            var user = await memoryCache.GetOrCreateAsync(cacheKey, async e =>
            {
